...
#     s1  = Student("王林",90,93,98)
#     print(s1)
#
#     s1.update_score(english=10)
#     print(s1)
...
class EduManagement:
    ...
    def run(self):
        ...
        while True:
            print()
            print("######################################################")
            print("# 1.添加学生 2.修改学生 3.删除学生 4.查询指定学生5.查询所有学生 6.退出系统#")
            print("######################################################")
            print()
            choice = input("请选泽要执行的操作,输入1-6")
            try:
                match  choice:
                    case "1":   #  添加学生
                        self.add_student()
                    ...
                    case "6":  #推出系统
                        ...
                        break
                    case _: #其他情况
                        print("输入错误,请选泽1-6之间的菜单功能!")
            except ValueError:
                print("输入的数据有问题,请检查,然后重新输入!!!")
            except Exception :
                print("程序运行从出错了,请重新选泽-")
